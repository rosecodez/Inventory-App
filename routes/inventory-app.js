// Create router for all the URLs needed by the inventory-app website
// which will call the controller functions
...
/// 3. ----------  Fan routes  ---------- ///
// GET fan home page.
router.get('/', fan_controller.index);
...
router.get('/', memory_controller.index);
...
// GET motherboard home page.
router.get('/', motherboard_controller.index);
...
/// 7. ----------  psu routes  ---------- ///
// GET psu home page.
router.get('/', psu_controller.index);
